<div class="modal fade" id="modal_show" role="dialog" style="padding:0;">
    <div class="modal-dialog modal-dialog-scrollable modal-md" role="document">
        <div class="modal-content">
            ...
            <form method="post" action="{{ route('barang.store') }}" id="idForm">
                @csrf
                <div class="modal-body">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="merk" class="form-control form-control-sm" placeholder="Merk"
                            autocomplete="off">
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <textarea name="spesifikasi" class="form-control form-control-sm" placeholder="Spesifikasi"></textarea>
                    </div>
                    <div class="form-group">
                        ...
                        <select name="klasifikasi_id" id="klasifikasi_id" class="form-control form-control-sm" required>
                            ...
                            <option value="{{ $key->id }}">{{ $key->nama_klasifikasi }}</option>
                            @endforeach
                        </select>
                    </div>
                </div>
