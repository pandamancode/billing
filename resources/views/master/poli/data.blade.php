...
@section('sub-breadcrumb', 'Data Poli')
@section('content')
    <div class="row">
        <div class="col-md-12">
            <div id="respon">
            ...
            @include('master.poli.filter')
            @if($showTable)
            <div class="panel">
                <div class="panel-heading">
                    <div class="row">
                        <div class="col-sm-6 panel-title">Data Poli</div>
        ...
        <script>
            ...
            $(function() {
                ...
                $(document).on("click", ".btn-update", function() {
                    ...
                    var url = "{{ route('poli.edit', ':id_data') }}";
                ...
                $(document).on("click", ".btn-delete", function() {
                    var id = $(this).attr("data-id");
                    var url = "{{ route('poli.show', ':id_data') }}";
                    url = url.replace(":id_data", id);
                    $.ajax({
                            method: "GET",
                            url: url,
